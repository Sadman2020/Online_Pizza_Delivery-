      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pizza Wala</span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">PizzaWala</h2><a href="https://github.com/MehediHasanToukir" target="_blank">@PizzaWala</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Pizza Wala</strong></h3>
            <h3><strong>One of the Best delivery service</strong></h3> 
            <p class="font-italic">
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 190px;">
          ...
          <div class="" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/ayon.jpeg"   class="img-fluid "  style=" height: 300px; width: 270px" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Rashed Rayhan Ayon</h4>
                </div>
                <div class="social">
          ...
          <div class="" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/Faisal.jpg" style=" height: 300px; width: 270px" class="img-fluid  " alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Faisal Ahmed</h4>
                </div>
          ...
          <div class="" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/choyon.jpg" class="img-fluid  " style=" height: 300px; width: 200px" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Majhaharul Islam</h4>
                </div>
                <div class="social">
                  <a href="https://twitter.com/" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://github.com/" target="_blank"><i class="fab fa-github"></i></a>
          ...
          <div class="" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/mehedi.jpg" class="img-fluid " style=" height: 300px; width: 270px" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Mehedi Hasan Toukir</h4>
                </div>
                <div class="social">
                  <a href="https://twitter.com/" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://github.com/MehediHasanToukir" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="https://www.linkedin.com/in/Mehedi Hasan Toukir/" target="_blank"><i class="icofont-linkedin" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="" data-wow-delay="0.2s">
            <div class="member">
              <img src="team members/sadman.jpg" class="img-fluid" style=" height: 300px; width: 270px" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sadman Shakib</h4>
                </div>
          ...
          <div class="" data-wow-delay="0.2s">
            <div class="member">
              <img src="team members/likhon.jpg" class="img-fluid "  style=" height: 300px; width: 200px" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Istiak Tareq</h4>
                </div>
